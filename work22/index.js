...
window.onload = function () {
    ...
    for(var i=0, j = radios.length; i< j;i++) {
        radios[i].onclick = function () {
            ...
            IntersectionObserver(value, value, value * value /5 - value, value * value /5);
            document.getElementById("JMS_main").style.width = valuec* 40 + 180 + 60 + "px";
        }
    }
    init(10, 10);
};
function init(rowCount, colCount, minLandMineCount, maxLandMineCount) {
    ...
    jms = JMS("land,ine", rowCount, colCount, minLandMineCount, maxLandMineCount);
